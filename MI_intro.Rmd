...
my_path = here::here("DataCode")

# define file for different .tif files
component = here::here("DataCode", "lung_component_data.tif") 
binseg =  here::here("DataCode", "lung_binary_seg_maps.tif")
composite_tif = here::here("DataCode", "lung.tif")
```
