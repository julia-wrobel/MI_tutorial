...
An example multichannel tiff image can be found [here](lung_component_data.tif), with binary segmentation maps [here](lung_binary_seg_maps.tif), and a composite image [here](lung.tif).
