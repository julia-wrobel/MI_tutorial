...
Below I do some exploratory data analysis with multichannel tiff files from a Vectra instrument. We are looking at a tissue slice from a patient with lung cancer.
...
EBImage::display(t(dapi_channel), method = "raster")
...
Try with an image from the MIBI paper
