...
Below I briefly talk about loading and visualizing raw TIFF data. The rest of the workshop will focus on data in tabular form post segmentation.

### Lung cancer data

Below I do some exploratory data analysis with multichannel tiff files from a Vectra instrument. We are looking at a tissue slice from a patient with non small cell lung carcinoma from one of the datasets available in the `VectraPolarisData` package.


Cell and tissue segmentation and cell phenotyping were performed using inForm software. For each image, there are multiple Tiff files:
...
component = url("https://github.com/julia-wrobel/MI_tutorial/raw/main/DataCode/%2316%203-171-807_%5B62243%2C18509%5D_component_data.tif")
binseg = url("https://github.com/julia-wrobel/MI_tutorial/raw/main/DataCode/%2316%203-171-807_%5B62243%2C18509%5D_binary_seg_maps.tif")

composite_tif = url("https://github.com/julia-wrobel/MI_tutorial/raw/main/DataCode/%2316%203-171-807_%5B62243%2C18509%5D.tif")
```


The subject and image ID are embedded in the file name. For example, for the file "#12 2-690-981 P44_[48428,17215].tif", "12 2-690-981" is the subject id, and "48428,17215" is the image ID. 
